...
const programAddress = '9xQeWvG816bUx9EPjHmaT23yvVM2ZWbrrpZb9PusVFin'; // serum v3
const pairName = 'LAUNCHLABSOL'

const tempMarketAddress = 'EMFSwgaEeAp5rm6CXLyJLqgVX8hnfZEmTJdgQKvmwjUx'


const main = async () => {
  let amm = new SerumAMM(pairName, rpcUrl, dev_private_key, tempMarketAddress, programAddress);
